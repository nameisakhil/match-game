...
class App extends Component {
  state = {
    ...
    score: 0,
    timer: 60,
    activeImage: imagesList[0].thumbnailUrl,
  ...
  onClickImage = id => {
    const {activeImageId, timer, timeElapsedInSeconds} = this.state
    const num = Math.floor(Math.random() * imagesList.length + 1)

    const newImageUrl = imagesList[num].thumbnailUrl
    const newActiveImageId = imagesList[num].id
    ...
    const isTimerCompleted = timeElapsedInSeconds === timer
      ...
      <div className="game-container">
          ...
          <ul className="score-timer-container">
            ...
            <li className="timer-container">
              <img
                ...
                className="timer"
              />
              <h1 className="seconds">{timer} sec</h1>
            </li>
          </ul>
        </nav>
        ...
        {isTimerCompleted ? (
          <div className="score-card">
            ...
            <h1 className="score-card-score">{score}</h1>
            <button
              type="button"
          ...
          <div className="match-container">
            <img src={activeImage} alt="match" className="thumbnail" />
